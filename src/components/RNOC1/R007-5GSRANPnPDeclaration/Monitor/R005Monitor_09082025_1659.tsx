...
const KpiMonitorTab: React.FC = () => {
  ...
  */
  ...
  useEffect(() => {
    ...
    setCurrentPage(1);
  }, [records, searchText, selectedProvince, selectedDistrict, selectedVendor, selectedRegion, startDate, endDate, sortField, sortDirection]);
        ...
        <div className="card-body p-3">
          <div className="row g-3">
            ...
            <div className="col-md-2">
              <select className="form-select" value={selectedProvince} onChange={(e) => setSelectedProvince(e.target.value)} style={{ borderRadius: "8px" }}>
            ...
            <div className="col-md-2">
              <select className="form-select" value={selectedDistrict} onChange={(e) => setSelectedDistrict(e.target.value)} style={{ borderRadius: "8px" }}>
