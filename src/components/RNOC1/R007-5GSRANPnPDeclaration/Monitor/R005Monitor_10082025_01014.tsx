        ...
        {isOpen && (
          <div
            ...
            style={{
              ...
              right: 0,
              zIndex: 1000,
              maxHeight: "400px", // ✅ Tăng từ 300px → 400px
              overflowY: "auto",
          ...
          >
            ...
            <div className="p-2 border-bottom bg-light">
              <div className="d-flex justify-content-between">
                <button type="button" className="btn btn-link btn-sm p-0" onClick={() => onChange(options)}>
                  Select All
                </button>
