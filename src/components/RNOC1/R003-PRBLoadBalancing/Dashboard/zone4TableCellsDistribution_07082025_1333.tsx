          ...
          */}
          ...
          <div>
            ...
            <div className="d-flex align-items-center justify-content-between mb-3 flex-nowrap">
              <h6 className="fw-bold mb-0">Provinces & Districts</h6>

              {/* Center: Province Selector */}
              <div className="d-flex align-items-center gap-2">
                <small className="text-muted mb-0">Add:</small>
                <Form.Select value="" onChange={handleAddProvince} style={{ width: "140px", fontSize: "0.875rem" }} size="sm">
            ...
            */}
            ...
            <div className="mb-3">
              <small className="text-muted">Selected Provinces:</small>
              <div className="d-flex flex-wrap gap-2 mt-1">
                {selectedProvinces.map((province) => (
                  <Badge key={province} bg="primary" className="d-flex align-items-center gap-1 p-2">
                    {province}
